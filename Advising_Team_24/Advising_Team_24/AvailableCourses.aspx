<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AvailableCourses.aspx.cs" Inherits="Advising_Team_24.AvailableCourses" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <asp:Button ID="Button2" runat="server" Text="Back to Main Menu" CssClass="mainbutton" OnClick="Button2_Click" />
